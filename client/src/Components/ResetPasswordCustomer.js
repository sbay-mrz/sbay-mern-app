...
export default class ResetPasswordCustomer extends Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get(`https://sbay-server.herokuapp.com/customers/reset/${this.props.match.params.token}`)
      .then((response) => {
  ...
  updatePassword = (e) => {
    ...
    axios
      .patch(`https://sbay-server.herokuapp.com/customers/customerupdate/${this.state.userId}`, {
